import { Calendar, Filter, Volume2, ChevronDown } from 'lucide-react';
        ...
        <aside className="hidden lg:flex flex-col lg:w-1/3 bg-gray-50">
          ...
          <div className="rounded-[22px] bg-white p-5 shadow-sm mb-4">
            <div className="bg-[url('/images/newsletter.png')] bg-right-top bg-no-repeat">
              <div className="">
                <div className="font-bold text-[22px] mb-2">انضم إلى قائمة نشرتنا الإخبارية</div>
                <div className="text-base pb-2">اشترك للحصول على محتوى حصري وتحديثات منتقاة</div>
              </div>
            </div>
            <div className="w-full mt-3">
              ...
              />
              <button className="w-full mt-4 py-2 bg-gray-200 text-gray-400 rounded-md font-medium" disabled>
                إشترك
              </button>
            </div>
          </div>
